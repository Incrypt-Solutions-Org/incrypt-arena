 ...
 * Also includes the Add Course form (merged for fewer tabs)
 */
import { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { GraduationCap, Edit, Trash2, Check, X, ExternalLink, Plus, ChevronUp } from 'lucide-react';
...
export function CoursesPanel({ players }: CoursesPanelProps) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <span>{showAddForm ? 'Hide Form' : 'Add Course'}</span>
        </button>
      </div>
        ...
        {showAddForm && (
          ...
          >
            <div className="border border-neon-blue/30 rounded-lg p-4 bg-cyber-darker/50">
              <CourseForm players={players} onSuccess={handleFormSuccess} />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
